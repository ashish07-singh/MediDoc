        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-12'>
          ...
          <div>
            ...
            <ul className='flex flex-col gap-3'>
              <li><Link to="/" className='hover:text-teal-600 transition-colors duration-300'>Home</Link></li>
              <li><Link to="/about" className='hover:text-teal-600 transition-colors duration-300'>About Us</Link></li>
              <li><Link to="/doctors" className='hover:text-teal-600 transition-colors duration-300'>Doctors</Link></li>
              <li><Link to="/contact" className='hover:text-teal-600 transition-colors duration-300'>Contact</Link></li>
            </ul>
          </div>
