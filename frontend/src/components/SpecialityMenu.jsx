...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-6 py-16 text-teal-900 bg-white'>
            
            <h1 className='text-4xl font-bold text-teal-600 md:text-4xl '>Find by Speciality</h1>
