                            ...
                            <div className="flex flex-row lg:flex-col gap-2 overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0">
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2 rounded-lg transition-colors duration-200 text-sm font-medium ${
                                        !speciality ? 'bg-teal-600 text-white shadow' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                    }`}
                                >
                                    All
                                </button>
                                ...
                                {specialityList.map(s => (
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 rounded-lg transition-colors duration-200 text-sm font-medium whitespace-nowrap ${
                                            speciality === s ? 'bg-teal-600 text-white shadow' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                        }`}
                                    >
                                        {s}
                                    </button>
                    ...
                    <main className="flex-1">
                        {filteredDoctors.length > 0 ? (
                            <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8'>
                                {filteredDoctors.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className='p-5'>
                                            <p className='text-xl font-bold text-gray-800 group-hover:text-teal-600 transition-colors duration-300'>
                                                {item.name}
                                            </p>
                            ...
                            <div className="flex flex-col items-center justify-center bg-white p-10 rounded-lg shadow-md h-full">
                                ...
                                <button onClick={() => navigate('/doctors')} className='mt-6 bg-teal-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-teal-700 transition-colors'>
                                    View All Doctors
                                </button>
                            </div>
                        )}
